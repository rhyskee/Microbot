...
public class GreenDragonsOverlay extends OverlayPanel {
    ...
    @Inject
    public GreenDragonsOverlay(Client client, ModelOutlineRenderer modelOutlineRenderer) {
        this.client = client;
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        int distanceToSafeSpot = playerLocation.distanceTo(GreenDragonsScript.SAFE_SPOT);
    ...
    private String formatState() {
        if (GreenDragonsScript.currentState == null) {
            return "UNKNOWN";
        }
        
        String state = GreenDragonsScript.currentState.toString();
    ...
    private Color getStateColor() {
        ...
        switch (GreenDragonsScript.currentState) {
            case BANKING:
                return Color.YELLOW;
    ...
    private void drawSafeSpot(Graphics2D graphics) {
        ...
        LocalPoint localSafeSpot = LocalPoint.fromWorld(Microbot.getClient().getTopLevelWorldView(), GreenDragonsScript.SAFE_SPOT);
